...
INSERT INTO `#__pf_mailtemplates` (`id`, `title`, `subject`, `body`, `altbody`, `thankyou`, `html`, `params`, `protected`, `language`) 
VALUES (1, 'Default', '{questionnaire_title} questionnaire', '<p>{recipient_name}, <br />the following is the results list of the "{questionnaire_title}" questionnaire you filled at {website}.</p>\r\n<p>{results}</p>\r\n<p>Best Regards<br />{website} team.</p>', '{recipient_name},\r\nthe following is the results list of the "{questionnaire_title}" questionnaire you filled at {website}.\r\n\r\n{results}\r\n\r\nBest Regards\r\n{website} team.', '<h2>The email message has been sent.</h2>', 1, '{"show_submitter":"1","show_submitter_name":"1","show_recipient_name":"1","show_tc":"0","tc_id":"","show_titles":"1","show_links":"1"}', 1, '*');